...
const PortfolioPage = lazy(() =>
  import("./pages/portfolio-page/portfolio-page.component")
);
  ...
  useEffect(() => {
    const measureTop = () => {
      if (document.querySelector("#route-container").offsetHeight > 1000) {
        if (
          document.querySelector("#route-container").offsetHeight <=
          window.scrollY + window.innerHeight - 20
        ) {
          setTothetopIsAvtive("appear");
        } else if (
          document.querySelector("#route-container").offsetHeight - 200 >=
          window.scrollY + window.innerHeight - 20
        ) {
    ...
    <div className="website">
      ...
      <BrowserRouter>
        ...
        <div id="route-container">
          <div
            className={`to-the-top ${tothetopIsAvtive}`}
            onClick={goToTop}
          ></div>
          <Suspense
            fallback={
